...
class Proj1Data:
    ...
    def export_collection_as_dataframe(self, collection_name: str, database_name: Optional[str] = None) -> pd.DataFrame:
        ...
        try:
            ...
            raise MyException(e, sys) ## this filehelp to establish connection with mongo_db_connection file and fetch 
                                      ## data from mongodb by accesing the keys writeen in it